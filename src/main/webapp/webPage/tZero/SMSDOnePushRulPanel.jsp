...
<body
	...
	<div class="page-container">
       ...
       <!-- BEGIN CONTENT -->
		<div class="portlet-body form">
			<div style="margin:10px 15px 0px 15px;"><h5 style="font-weight:bold;">SMS自动推送规则设置</h5></div>
	        <!-- 右边开始 -->
	        <div class="row norow">
                    ...
                    <div class="portlet-body wheel" style="overflow-x:auto;">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-18">
                               <div class="form-group">
                               	<label class="control-label col-md-4 text-right" style="font-weight: bold;">SMS推送开通的条件:</label><br/><br/>
                                 	...
                                 	<div class="col-md-8 paddingnone" style="width:62%; float:left;padding-left:0px;">
                                          ...
                                          <input name="balence" type="number" id="balence_sms" class="form-control" value="0.5" style="width:80%;float:left;" min="0"> 
                         	...
                         	<div class="col-lg-10 col-md-12 col-sm-12 col-xs-18">
                               <div class="form-group">
                                 	...
                                 	<div class="col-md-8 paddingnone" style="width:62%; float:left;padding-left:0px;">
                                          	...
                                          	<input name="tm1" type="number" id="tm1_sms" class="form-control"  style="width:30%;float:left;" min="0"> 
                                         	<div style="float:left;ont-weight: 400;margin-top: 5px;">&nbsp;点 &nbsp;&nbsp;&nbsp;&nbsp;</div>
                                         	<input name="tm2" type="number" id="tm2_sms" class="form-control" style="width:30%;float:left;" min="0">&nbsp;
                                         	<div style="float:left;ont-weight: 400;margin-top: 5px;"> 点</div>
    ...
    $(function(){
    	...
    	//获取系统配置值
    	var url = baseURL +　"/pushRul/queryDOneSMSPushRul?page=1&start=0&limit=25";
    	$.ajax({
            type: "GET",
            url: url,
            ...
            success: function(data) {
            	...
            	if(data.balence!=null){
            		$("#balence_sms").val(data.balence);
            		balence= data.balence;
            	}
				if(data.tm1!=null){
					$("#tm1_sms").val(data.tm1);  
					tm1= data.tm1;
				}
				if(data.tm2!=null){
					$("#tm2_sms").val(data.tm2);
					tm2= data.tm2;
				}
            },
            error:function(){ }
        ...
        $("#sure_btn").on("click",function(){
        	...
        	App.blockUI({target:"body",boxed:!0,message:"SMS自动推送规则设置中，请稍等...",zIndex:20000});
        	
        	var dealUrl = baseURL + "/pushRul/addDOneSMSPushRul";
        	$.ajax({
                type: "POST",
                url: dealUrl,
                data:param,
                ...
                error:function(){
                	bootbox.alert("SMS自动推送规则设置失败，请刷新重试.");
                }
        	});
        });
