		                        ...
		                        <table  class="table table-striped table-bordered table-hover table-checkable order-column" id="queryMecGrid">
		                            <thead>
		                                <tr>
		                                    ...
		                                    <th class="nowrap"> 修改前单笔上限</th>
		                                    <th class="nowrap"> 修改前单笔下限</th>
		                                    <th class="nowrap"> 修改后费率</th>
		                                    <th class="nowrap"> 修改后单笔上限</th>
		                                    <th class="nowrap"> 修改后单笔下限</th> 
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {  
                	...
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.rateOld+"%"));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.maxAmtOld));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.minAmtOld));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.rate+"%"));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.maxAmt));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.minAmt));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.stffNo));
                	tr.append($("<td class=\"nowrap\"></td>").text(covertTimeData(obj.dtCte,obj.tmCte)));
