...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md" style="background-color:white;">
	<div style="maring:5px 5px 10px 5px;"><h5 style="font-weight:bold;" >等级修改操作记录</h5></div>
    <!-- BEGIN HEADER -->
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {  
                	...
                	if(obj.beforeMecLevel==''||obj.beforeMecLevel==null){
                		tr.append($("<td class=\"nowrap\"></td>").text(""));
                	}else{
                		tr.append($("<td class=\"nowrap\"></td>").text(obj.beforeMecLevel+"级"));
                	}
                	if(obj.afterMecLevel==''||obj.afterMecLevel==null){
                		tr.append($("<td class=\"nowrap\"></td>").text(""));
                	}else{
                		tr.append($("<td class=\"nowrap\"></td>").text(obj.afterMecLevel+"级"));
                	}
