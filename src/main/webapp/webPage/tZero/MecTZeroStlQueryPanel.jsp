								...
								<form action="<%=request.getContextPath()%>/mec/queryData"
									...
									<div class="form-body">
										<div class="row norow">
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="form-group">
													<label class="control-label col-md-4 text-right">开通日期:</label>
													<div class="col-md-8 paddingnone">
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="form-group">
													<label class="control-label col-md-4 text-right">商户T+0状态:</label>
													<div class="col-md-8 paddingnone">
														<select name="stlSts" id="queryMecStore_stlSts"
															class="bs-select form-control" data-show-subtext="true">
														</select>
													</div>
												</div>
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-search font-blue"></i> <span
										class="caption-subject font-blue bold uppercase">T+0商户信息列表</span>
								</div>
								<div class="tools">
									...
									<table
										...
										<thead>
											<tr>
												...
												<th class="nowrap">商户T+0业务状态</th>
												<th class="nowrap">商户T+0业务额度</th>
												<th class="nowrap">开通时间</th>
												<th class="nowrap">T+0类型</th>
												<th class="nowrap">分公司</th>
												<th class="nowrap">拓展员名称</th>
												<th class="nowrap">拓展员编号</th>
												<th class="nowrap">自动结算时间点</th>
											</tr>
										</thead>
										<tbody>
										</tbody>
...
<!--     <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.11.0/js/bootstrap-select.min.js"></script> -->
  ...
  //onedit
    ...
    //http://127.0.0.1:8080/bap/tZero/FcrMag/queryFcrInfo?_dc=1472111617720	
		...
		var stlSts  = $('#queryMecStore_stlSts').val();
		var orgNo  = $('#queryMecStore_orgNo').val();

    	var	url = baseURL + "/tZero/org/query/mec?dtCteBg="+strBg+"&dtCteEd="+strEd+"&orgNo="+orgNo+"&mno="+mno+"&stlTyp="+stlTyp+"&companyNo="+companyNo+"&stlSts="+stlSts+"&page="+page+"&start="+start+"&limit="+limit;
    ...
    $(function(){
		...
		$("#exportexcel_btn").on('click', function() {
			...
			bootbox.confirm("共有"+constTotalCount+"条数据，确认要导出吗?", function(truthBeTold){
				...
				if(truthBeTold){
					window.open(baseURL+"/tZero/org/exportT0MecInfoList");
				}else{
					return;
				}
  ...
  function initDefaultDate(){
  	...
  	$("#strBg").val(dateString);
  	$("#strEd").val(dateString);
