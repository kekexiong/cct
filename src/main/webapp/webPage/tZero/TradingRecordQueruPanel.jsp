									...
									<div class="form-body">
										<div class="row norow">
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<div class="col-md-8 paddingnone">
														<input name="TradingRecordQueruPanel_mno"
															id="TradingRecordQueruPanel_mno" class="form-control"
															placeholder="请输入商户编号">
													</div>
												</div>
											</div>
											...
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="span-medium-2"
														class="control-label col-md-4 text-right">用户名称:</label>
													<div class="col-md-8 paddingnone">
														<input name="TradingRecordQueruPanel_mec_Nm"
															id="TradingRecordQueruPanel_mec_Nm" class="form-control"
															placeholder="请输入用户名称">
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<div class="col-md-8 paddingnone">
														<select name="TradingRecordQueruPanel_companyNo"
															id="TradingRecordQueruPanel_companyNo"
															class="bs-select form-control" data-size="10">
														</select>
											...
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="span-medium-2"
														class="control-label col-md-4 text-right">提取金额范围:</label>
													<div class="col-md-3 paddingnone">
														<input name="TradingRecordQueruSTM_AMT"
															id="TradingRecordQueruSTM_AMT"
															class="form-control col-md-3 onlyNum" min='0' type="number">
													</div>
													<label class="control-label col-md-2 text-right">至:</label>
													<div class="col-md-3 paddingnone">
														<input name="TradingRecordQueru_AMT"
															id="TradingRecordQueru_AMT"
															class="form-control col-md-3 onlyNum" min='0' type="number">
													</div>
												</div>
											</div>
										...
										<div class="row norow">
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<div class="col-md-8 paddingnone">
														<select name="TradingRecordQueruPanel_usrStsCombo"
															id="TradingRecordQueruPanel_usrStsCombo"
											...
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<div class="col-md-8 paddingnone">
														<input name="TradingRecordQueruPanel_retReNo"
															id="TradingRecordQueruPanel_retReNo"
											...
											<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<div class="col-md-8 paddingnone">
														<input name="TradingRecordQueruPanel_tranCrdNo"
															id="TradingRecordQueruPanel_tranCrdNo"
															class="form-control col-md-4"
															>
													</div>
												</div>
										...
										<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-8 paddingnone">
													<select name="TradingRecordQueruPanel_ChannelId"
														id="TradingRecordQueruPanel_ChannelId"
														class="bs-select form-control" data-show-subtext="true">
														<option value="">全部</option>
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-search font-blue"></i> <span
									class="caption-subject font-blue bold uppercase">闪电到账申请记录信息列表</span>
							</div>
							<div class="tools">
...
<!--     <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.11.0/js/bootstrap-select.min.js"></script> -->
  ...
  //onedit
    ...
    //http://127.0.0.1:8080/bap/tZero/FcrMag/queryFcrInfo?_dc=1472111617720	
		...
		param.startTime = $('#TradingRecordQueruPanel_dtCte').val().replace('/', '-').replace('/', '-'),
		param.endTime = $('#TradingRecordQueruPanel_dtCteEnd').val().replace('/', '-').replace('/', '-'),
		param.mec_Nm = $('#TradingRecordQueruPanel_mec_Nm').val(),
		param.stm_amt = $('#TradingRecordQueruSTM_AMT').val(),
		param.Tostm_amt = $('#TradingRecordQueru_AMT').val(),
		param.aud_Sts = $('#TradingRecordQueruPanel_usrStsCombo').val(),
    	...
    	var	url = baseURL + "/AppRecord/applyInfo";
		$.ajax({
            type: "GET",
            url: url,
            data:param,
    			...
    			tableData = $.extend(true, {}, data);//cache
                    ...
                    $.each(data.items, function(index, obj) {
                    	...
                    	if (!hasPermission(PERMISSSIONCONST.SDDZ0006)) {
                    		...
                    		trData.push("<INPUT type='button' value='详情' onclick = sddzQueryDetailView('"+obj.uuid+"','"+obj.inMno+"')>");
                    	}
                    	...
                    	trData.push(obj.mec_Nm);
                    	trData.push(obj.stmAmt);
                    	trData.push(obj.feeAmt);
                    	trData.push(transferTime(obj.strDt));
                    	trData.push(obj.channelId);
                    	
                    	trData.push(obj.aud_Sts);
                    	trData.push(obj.devNo);
                    	trData.push(obj.devNm);
                    	trData.push(obj.orgNm);
                    	trData.push(obj.companyNm);
                    	trData.push(obj.audId);
                    	
                    	trData.push(transferTime(obj.audDt));
...
/*     	if (!hasPermission(PERMISSSIONCONST.TZERO501)) {$("#query_btn").hide();}
        ...
        sbjStore();
        initDefaultDate();
        getComboStore("queryMecStore_stlSts","STL_STS"),
		//查询按钮
      ...
      /*   
        $('#queryMecPanel_Form').bootstrapValidator({trigger:'blur',
	        fields: {
