		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {  
                	...
                	tr.append($("<td class=\"nowrap\"></td>").text(formartSysId(obj.sysId)));
                	
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.dttmCte));
...
function formartSysId(value){
	if("BAP01"==value){ return 'BAP单个修改'; }
	if("BAP02"==value){ return 'BAP批量修改'; }
	if("AF01"==value) { return '代理商前台单个修改'; }
	if("AF02"==value) { return '代理商前台批量修改'; }
	if("BF01"==value) { return '代理商后台单个修改'; }
	if("BF02"==value) { return '代理商后台批量修改'; }
}
