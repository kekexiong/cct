...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md" style="background-color:white;">
	<div style="maring:5px 5px 10px 5px;"><h5 style="font-weight:bold;" >结算人名下商户</h5></div>
    <!-- BEGIN HEADER -->
   <%--  <jsp:include page="../common/header.jsp" flush="true"/> --%>
    ...
    function reloadGrid() {
    	...
    	var uuid ='<%=uuid%>';
    	var url=baseURL+'/tZero/posMdStmLevel/detail';
    	$('table > tbody').empty();
    	if(limit==0) {
    		//默认20条
    		limit=10;
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {
                	...
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.actNo));
                	var mecLevel = obj.mecLevel;
                	if(mecLevel!=null){
                		mecLevel = mecLevel+"级";
                	}
                	tr.append($("<td class=\"nowrap\"></td>").text(mecLevel));
