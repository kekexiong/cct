...
<%
String topAgentNo=request.getParameter("topAgentNo");
%>	
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md" style="background-color:white;">
	<div style="maring:5px 5px 10px 5px;"><h5 style="font-weight:bold;" >上限变更操作记录</h5></div>
    <!-- BEGIN HEADER -->
		                        ...
		                        <table  class="table table-striped table-bordered table-hover table-checkable order-column" id="queryMecGrid">
		                            <thead>
		                                <tr>
		                                    ...
		                                    <th class="nowrap"> 操作类型</th>
		                                    <th class="nowrap"> 变更前上限</th>
		                                    <th class="nowrap"> 变更后上限</th>
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {  
                	...
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.topAgentNo)); 
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.orgNm)); 
                	
                	var	posMdTyp = obj.posMdTyp;
                	...
                	tr.append($("<td class=\"nowrap\"></td>").text(posMdTyp));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.mecNumLimitBf));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.mecNumLimitAf));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.opCte));
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.dtCte));
