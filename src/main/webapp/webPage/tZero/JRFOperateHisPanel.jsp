		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {  
                	...
                	tr.append($("<td class=\"nowrap\"></td>").text(obj.cprRegNmCn));
                	tr.append($("<td class=\"nowrap\"></td>").text(formartStatus(obj.orignStlSts)));
                	tr.append($("<td class=\"nowrap\"></td>").text(formartStlSts(obj.stlSts)));
