...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md" style="background-color:white;">
	<div style="maring:5px 5px 10px 5px;"><h5 style="font-weight:bold;" >限额操作记录</h5></div>
    <!-- BEGIN HEADER -->
		                        ...
		                        <table  class="table table-striped table-bordered table-hover table-checkable order-column" id="queryMecGrid">
		                            <thead>
		                                <tr>
		                                    ...
		                                    <th class="nowrap"> 原限额 </th>
		                                    <th class="nowrap"> 变更限额</th>
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.items, function(index, obj) {  
                	...
                	if(obj.beforeLimit==''||obj.beforeLimit==null){
                		tr.append($("<td class=\"nowrap\"></td>").text('无上限'));
                	}else{
                		tr.append($("<td class=\"nowrap\"></td>").text(obj.beforeLimit));
                	}
                	if(obj.afterLimit==''||obj.afterLimit==null){
                		tr.append($("<td class=\"nowrap\"></td>").text('无上限'));
                	}else{
                		tr.append($("<td class=\"nowrap\"></td>").text(obj.afterLimit));
                	}
