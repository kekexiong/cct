		                    ...
		                    <div class="portlet-body form"> 
		                    	<form action="<%=request.getContextPath()%>/mec/queryData" class="form-horizontal" id="queryMecPanel_Form">
		                            <div class="form-body">
		                                    ...
		                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
		                                        <div class="form-group">
		                                            <label class="control-label col-md-4 text-right">开通渠道 :</label>
		                                            <div class="col-md-8 paddingnone">
		                                                <select name="openSysFlag" id="openSysFlag" class="bs-select form-control" data-show-subtext="true">
		                                                </select>
		                                            </div> 
		                                        </div>
		                                    </div> 
		                                    ...
		                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                     		  <div class="form-group">
                                     	 	     <label for="span-medium-1" class="control-label col-md-4 text-right">秒到商户等级 :</label>
                                        		   <div class="col-md-8 paddingnone">
                                       			        <select name="mecLevel" id="mecLevel" class="bs-select form-control" data-show-subtext="true">
				            								<option value="">全部</option>	
		                                    ...
		                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
		                                        <div class="form-group">
		                                            <label class="control-label col-md-4 text-right">等级状态 :</label>
		                                            <div class="col-md-8 paddingnone">
		                                        ...
		                                        <div class="row">
		                                            <div class="col-md-offset-1 col-md-11">
		                                             	<button type="button" id="query_btn" class="btn btn-success"><i class="fa fa-search"></i> 查询</button>
		                                             	 ...
		                                             	 <button type="button" id="mecq_detail_btn" class="btn tn btn btn-primary"> <i class="fa fa-edit"></i> 查看费率详情</button>
...
时		                                    
   ...
   <!-- 订单详情（Modal） -->
    ...
    //查询数据
    function reloadGrid() {
		var url=baseURL+"/posMdMecQuery/queryPosMdMecList";
		...
		param.mecLevel=$('#mecLevel').val();
		param.mecLevelStatus=$('#mecLevelStatus').val();
		param.openSysFlag=$('#openSysFlag').val();
		param.posMdTyp=$('#posMdTyp').val();
    ...
    $(function(){
    	...
    	getComboStore('openSysFlag', 'OPEN_SYS_FLAG');
    	getComboStore('mecLevelStatus', 'MEC_LEVEL_STATUS');
