    ...
    $(function(){
      ...
      $.each(data.items, function(index, obj) {  
    	  var tr = $("<tr></tr>").append($("<td><input type=\"checkbox\" class=\"checkboxes\" onclick=\"clickCheck(this)\" rownum=\""+index+"\" /></td>"));
        	...
        	tr.append($("<td class=\"nowrap\"></td>").text(obj.optResult));
        	tr.append($("<td class=\"nowrap\"></td>").text(obj.errorMsg)); 
		...
		var titileWain='本次批量导入调整商户随意通结算费率共成功<font color="red">'+data.successCount+'</font>条,失败<font color="red">'+
