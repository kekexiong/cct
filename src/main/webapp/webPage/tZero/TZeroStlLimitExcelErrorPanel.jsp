   ...
   <%--  <jsp:include page="../common/header.jsp" flush="true"/> --%>
		                                    ...
		                                    <div class="col-md-12">
		                                        <div class="row">
		                                            <div class="col-md-offset-1 col-md-11">
		                                                <button type="button" id="exportexcel_btn" class="btn btn btn-primary"> <i class="fa fa-sign-out"></i> 确定</button>
		                                            </div>
		                                        </div>
		                                    </div> 
		                                </div>
    ...
    $(function(){
      ...
      $.each(data.errors, function(index, obj) {  
		...
		var titileWain='本次批量导入调整即日付额度共成功<font color="red">'+data.successCount+'</font>条,失败<font color="red">'+
